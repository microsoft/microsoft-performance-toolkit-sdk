...
{
    //
    // This is a sample ProcessingSource that understands files with the .txt extension
    //

    //
    // In order for a ProcessingSource to be recognized, it MUST satisfy the following:
    //  a) Be a public type
    ...
    [ProcessingSource(
        "{F73EACD4-1AE9-4844-80B9-EB77396781D1}",  // The GUID must be unique for your ProcessingSource. You can use Visual Studio's Tools -> Create Guid… tool to create a new GUID
    ...
    //
    // There are two methods to creating a ProcessingSource that are recognized by the SDK:
        ...
        : ProcessingSource
    {
        ...
        public override ProcessingSourceInfo GetAboutInfo()
        {
            return new ProcessingSourceInfo
            {
                ...
                {
                    "This ProcessingSource is a sample showcasing the Performance Toolkit SDK.",
                }
            };
        }
        ...
        protected override bool IsDataSourceSupportedCore(IDataSource dataSource)
        {
            ...
            // to peek inside the file to truly determine if you can support it, especially if your ProcessingSource supports a common
