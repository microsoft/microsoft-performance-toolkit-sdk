...
namespace SimplePlugin.Tables.Metadata
{
    //
    ...
    public sealed class FileStatsMetadataTable
    {
        public static TableDescriptor TableDescriptor = new TableDescriptor(
            Guid.Parse("myid03"), // The GUID must be unique across all tables
            ...
            requiredDataCookers: new List<DataCookerPath> { new DataCookerPath( Constants.CookerPath) },
            isMetadataTable: true);                                                // Marks this table as a metadata table
        ...
        public static void BuildTable(ITableBuilder tableBuilder, IDataExtensionRetrieval tableData)
        {
            ...
            var fileNames = lines.Keys.ToArray();
            ...
            var lineCountProjection = fileNameProjection.Compose(x => lines[x].Count);
            ...
            var wordCountProjection = Projection.CacheOnFirstUse(
                fileNames.Length,
                fileNameProjection.Compose(x => lines[x].Count()));
