...
{
    /// <summary>
    ///     Wraps a <see cref="Func{T1, T2, T3, TResult}"/> into an
    ///     <see cref="IFunc{T1, T2, T3, TResult}"/>.
    /// </summary>
    /// <typeparam name="T1">
    ...
    /// </typeparam>
    public struct DelegateFunc<T1, T2, T3, TResult>
        : IFunc<T1, T2, T3, TResult>
    {
        ...
        /// </param>
        public DelegateFunc(Func<T1, T2, T3, TResult> func)
        {
            if (func == null)
            {
