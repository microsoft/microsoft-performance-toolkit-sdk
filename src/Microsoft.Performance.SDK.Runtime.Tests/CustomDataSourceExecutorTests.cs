	...
	public class CustomDataSourceExecutorTests
	{
		...
		public void ExecuteWithNullExecutionContextThrows()
		{
			Assert.ThrowsException<ArgumentNullException>(
				() => this.Sut.InitializeCustomDataProcessor(null, new NullLogger()));
		}
		...
		public void ExecuteSourceThatReturnsNullThrows()
		{
			...
			Assert.ThrowsException<InvalidOperationException>(
				() => this.Sut.InitializeCustomDataProcessor(executionContext, logger));
		}
		...
		public async Task ExecuteRequestedtablesSetCorrectly()
		{
			...
			this.Sut.InitializeCustomDataProcessor(executionContext, logger);
			var result = await this.Sut.ExecuteAsync(CancellationToken.None, logger);
		...
		public async Task ExecuteCallsProcessCorrectly()
		{
			...
			this.Sut.InitializeCustomDataProcessor(executionContext, logger);
			var result = await this.Sut.ExecuteAsync(this.Cts.Token, logger);
