...
{
    /// <summary>
    ///     Converts instances into <see cref="LargeSignedBytes"/>
    ///     instances.
    /// </summary>
    public sealed class LargeSignedBytesConverter
        : TypeConverter,
          ICustomTypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value)
        {
            ...
            if (asString != null)
            {
                ...
                {
                    return new LargeSignedBytes(parsedLong);
                }
            }
        ...
        {
            return typeof(LargeSignedBytes);
        }
    }
}
