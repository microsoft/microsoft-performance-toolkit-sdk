    ...
    : IReadOnlyList<Landmark>
{
    ...
    public abstract Landmark this[int index] { get; }

    /// <inheritdoc cref="IReadOnlyCollection{T}.Count" />/>
    public abstract int Count { get; }

    /// <inheritdoc cref="IReadOnlyList{T}.GetEnumerator" />
    public abstract IEnumerator<Landmark> GetEnumerator();
...
public class LandmarkProvider
    : ILandmarkProvider,
      IDisposable
{
    private readonly ObservableCollection<Landmark> landmarks = [];
    ...
    /// <inheritdoc/>
    public LandmarkCollection Landmarks => this.dataSource;
    ...
    /// </returns>
    public async Task ProvideLandmarkAsync(Landmark landmark, CancellationToken cancellationToken)
    {
          ...
          IDisposable
    {
        ...
        /// </param>
        public ProviderLandmarkDataSource(ObservableCollection<Landmark> landmarks)
        {
        ...
        /// <inheritdoc />
        public override Landmark this[int index] => ((IReadOnlyList<Landmark>)landmarks)[index];

        /// <inheritdoc />
        public override int Count => ((IReadOnlyCollection<Landmark>)landmarks).Count;

        /// <inheritdoc />
        public override IEnumerator<Landmark> GetEnumerator()
        {
            return ((IEnumerable<Landmark>)landmarks).GetEnumerator();
        }
