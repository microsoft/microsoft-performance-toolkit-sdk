...
namespace Microsoft.Performance.SDK.Processing
{
    ...
    ///     <see cref="IVisibleDomainSensitiveProjection"/> interface.
    /// </summary>
    public static partial class Projection
    {
        ...
        /// </exception>
        public static IProjection<int, TAggregate> AggregateInVisibleDomain<T, TAggregate>(
            IProjection<int, T> projection)
        {
            ...
            var type = typeof(AggregateRowsInVisibleDomainColumnGenerator<,,>).MakeGenericType(typeArgs);
            var instance = Activator.CreateInstance(type, constructorArgs);

            var aggregation = (IProjection<int, TAggregate>)instance;

            return CacheVisibleDomainColumn.Create(aggregation);
        }
...
with anonymous methods for small tables.");
        ...
        private struct AggregateRowsInVisibleDomainColumnGenerator<T, TAggregate, TGenerator>
              ...
              where TGenerator : IProjection<int, T>
        {
            ...
            public object Clone()
            {
                if (this.DependsOnVisibleDomain)
                {
                    return new CachedGenerator<T, TGenerator>(
                        ...
                        false);  // data not ready until the visible domain is set.
                }
                else
                {
                    return this;
            ...
            public bool NotifyVisibleDomainChanged(IVisibleDomainRegion newVisibleDomain)
            {
                if (this.generator.NotifyVisibleDomainChanged(newVisibleDomain))
                {
                    this.ResetCache();
                    return true;
                }
        ...
        private static class CacheVisibleDomainColumn
        {
            public static IProjection<TArg, TResult> Create<TArg, TResult>(IProjection<TArg, TResult> projection)
            {
                ...
                var type = typeof(CacheVisibleDomainColumnGenerator<,>).MakeGenericType(typeArgs);
                var instance = Activator.CreateInstance(type, constructorArgs);
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private struct CacheVisibleDomainColumnGenerator<T, TGenerator>
            : IProjection<int, T>,
              IVisibleDomainSensitiveProjection
              where TGenerator : IProjection<int, T>
        {
            ...
            public CacheVisibleDomainColumnGenerator(TGenerator generator)
            {
                this.generator = generator;
            ...
            public object Clone()
            {
                if (VisibleDomainSensitiveProjection.DependsOnVisibleDomain(this.generator))
                {
                    return new CacheVisibleDomainColumnGenerator<T, TGenerator>(
            ...
            public bool NotifyVisibleDomainChanged(IVisibleDomainRegion visibleDomain)
            {
                if (VisibleDomainSensitiveProjection.NotifyVisibleDomainChanged(this.generator, visibleDomain))
                {
            ...
            public bool DependsOnVisibleDomain => VisibleDomainSensitiveProjection.DependsOnVisibleDomain(this.generator);
              ...
              where TProjection1 : IProjection<T1, T2>
        {
            ...
            public object Clone()
            {
                if (this.DependsOnVisibleDomain)
                {
                    return new ProjectorGeneratorFunction<T1, T2, TResult, TProjection1>(
                        this.projection1.CloneIfVisibleDomainSensitive(),
                        projector);
                }
                else
                {
            ...
            {
                bool result = false;
                result |= this.projection1.NotifyVisibleDomainChanged(newVisibleDomain);
                return result;
            }

            public bool DependsOnVisibleDomain => this.projection1.DependsOnVisibleDomain();
        }
              ...
              where TProjection2 : IProjection<T1, T3>
        {
            ...
            public object Clone()
            {
                if (this.DependsOnVisibleDomain)
                {
                    return new ProjectorGeneratorFunction<T1, T2, T3, TResult, TProjection1, TProjection2>(
                        this.projection1.CloneIfVisibleDomainSensitive(),
                        this.projection2.CloneIfVisibleDomainSensitive(),
                        projector);
                }
                else
                {
            ...
            public bool NotifyVisibleDomainChanged(IVisibleDomainRegion newVisibleDomain)
            {
                bool result = false;
                result |= this.projection1.NotifyVisibleDomainChanged(newVisibleDomain);
                result |= this.projection2.NotifyVisibleDomainChanged(newVisibleDomain);
                return result;
            }

            public bool DependsOnVisibleDomain =>
                this.projection1.DependsOnVisibleDomain() ||
                this.projection2.DependsOnVisibleDomain();
        }
              ...
              where TProjection3 : IProjection<T1, T4>
        {
            ...
            public object Clone()
            {
                if (this.DependsOnVisibleDomain)
                {
                    return new ProjectorGeneratorFunction<T1, T2, T3, T4, TResult, TProjection1, TProjection2, TProjection3>(
                        this.projection1.CloneIfVisibleDomainSensitive(),
                        this.projection2.CloneIfVisibleDomainSensitive(),
                        this.projection3.CloneIfVisibleDomainSensitive(),
                        projector);
                }
                else
                {
            ...
            public bool NotifyVisibleDomainChanged(IVisibleDomainRegion newVisibleDomain)
            {
                ...
                result |= this.projection1.NotifyVisibleDomainChanged(newVisibleDomain);
                result |= this.projection2.NotifyVisibleDomainChanged(newVisibleDomain);
                result |= this.projection3.NotifyVisibleDomainChanged(newVisibleDomain);
                return result;
            }
            ...
            public bool DependsOnVisibleDomain =>
                this.projection1.DependsOnVisibleDomain() ||
                this.projection2.DependsOnVisibleDomain() ||
                this.projection3.DependsOnVisibleDomain();
        }
              ...
              where TProjection4 : IProjection<T1, T5>
        {
            ...
            public object Clone()
            {
                if (this.DependsOnVisibleDomain)
                {
                    return new ProjectorGeneratorFunction<T1, T2, T3, T4, T5, TResult, TProjection1, TProjection2, TProjection3, TProjection4>(
                        ...
                        this.projection2.CloneIfVisibleDomainSensitive(),
                        this.projection3.CloneIfVisibleDomainSensitive(),
                        this.projection4.CloneIfVisibleDomainSensitive(),
                        projector);
                }
                else
                {
            ...
            public bool NotifyVisibleDomainChanged(IVisibleDomainRegion newVisibleDomain)
            {
                ...
                result |= this.projection2.NotifyVisibleDomainChanged(newVisibleDomain);
                result |= this.projection3.NotifyVisibleDomainChanged(newVisibleDomain);
                result |= this.projection4.NotifyVisibleDomainChanged(newVisibleDomain);
                return result;
            }
            ...
            public bool DependsOnVisibleDomain =>
                ...
                this.projection2.DependsOnVisibleDomain() ||
                this.projection3.DependsOnVisibleDomain() ||
                this.projection4.DependsOnVisibleDomain();
        }
              ...
              where TFunction : IFunc<T1, T2, TResult>
        {
            ...
            public bool NotifyVisibleDomainChanged(IVisibleDomainRegion newVisibleDomain)
            {
                return this.projection1.NotifyVisibleDomainChanged(newVisibleDomain);
            }
