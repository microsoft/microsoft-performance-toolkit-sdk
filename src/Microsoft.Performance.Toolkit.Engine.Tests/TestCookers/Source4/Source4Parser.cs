...
namespace Microsoft.Performance.Toolkit.Engine.Tests.TestCookers.Source4
{
        ...
        : SourceParserBase<Source4DataObject, EngineTestContext, int>
    {
        ...
        public override string Id => nameof(Source4Parser);

        public override DataSourceInfo DataSourceInfo => DataSourceInfo.Default;

        public override void ProcessSource(
            ISourceDataProcessor<Source4DataObject, EngineTestContext, int> dataProcessor, 
            ILogger logger, 
