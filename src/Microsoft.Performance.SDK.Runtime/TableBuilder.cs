...
namespace Microsoft.Performance.SDK.Runtime
{
		  ...
		  ITableBuilderWithRowCount
	{
		...
		// might not even be needed right now if WPA project consumes from the 
		public ICollection<Insights.Insight> GetInsights()
		{
			return Insights.Insight.InsightsCollection;
		}
	}
}
