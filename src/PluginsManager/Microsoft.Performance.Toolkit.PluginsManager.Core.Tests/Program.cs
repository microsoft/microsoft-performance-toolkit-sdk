...
namespace Microsoft.Performance.Toolkit.PluginsManager.Core.Tests
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            string fileName = "d:\\test\\installed.json";
            using FileStream createStream = File.Create(fileName);
            await JsonSerializer.SerializeAsync(createStream, installedPlugin, options);
            ...
            {
                var installed = JsonSerializer.Deserialize<InstalledPlugin>(doc);
